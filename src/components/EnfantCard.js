            ...
            <div className="flex justify-between items-start mb-4">
                <div>
                    <h2 className="text-xl font-semibold text-gray-800">
                        {prenom} {nom} <span className="text-base font-normal text-gray-500">({age} ans)</span>
                    </h2>
                ...
                <div className="flex gap-1 md:gap-3 pt-1">
                    ...
                    <Can action="canArchive">
                        <div className="bg-gray-100 p-1 rounded-md" title="Archiver l'enfant">
                        <Archive
                            onClick={() => onArchive(id_enfant)}
                            className={`${iconClasses} text-gray-500 hover:text-gray-700 cursor-pointer`}
                            aria-label="Archiver"
                        />
                        </div>
                    </Can>
                    <Can action="canDelete">
                        <div className="bg-red-100 p-1 rounded-md" title="Supprimer l'enfant">
                        <Trash
                            onClick={() => onDelete(id_enfant)}
                            className={`${iconClasses} text-red-700 hover:text-red-900 cursor-pointer`}
